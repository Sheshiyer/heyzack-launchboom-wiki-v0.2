...
<CardGrid cols={2}>
  <Card title="🏗️ Foundation">
    Brand guidelines, personas, and strategic positioning
    
    **Explore:** [Foundation Resources](/foundation/)
    
    <Badge text="Strategy" variant="tip" />
  </Card>
  
  <Card title="🎯 Campaign Core">
    Campaign strategies, copy templates, and video scripts
    
    **Explore:** [Campaign Resources](/campaign-core/)
    
    <Badge text="Campaigns" variant="note" />
  </Card>
  
  <Card title="📧 Email Marketing">
    Email sequences and templates for all campaign stages
    
    **Explore:** [Email Templates](/email-marketing/)
    
    <Badge text="Email" variant="caution" />
  </Card>
  
  <Card title="📊 Advertising">
    Ad copy variations and campaign-specific advertising content
    
    **Explore:** [Ad Resources](/advertising/)
    
    <Badge text="Ads" variant="success" />
  </Card>
  
  <Card title="🎨 Visual Assets">
    Design guidelines, templates, and visual production resources
    
    **Explore:** [Visual Resources](/visual-assets/)
    
    <Badge text="Creative" variant="danger" />
  </Card>
  
  <Card title="🛠️ Supporting Materials">
    Additional tools, research, and campaign support resources
    
    **Explore:** [Support Tools](/supporting-materials/)
    
    <Badge text="Tools" variant="default" />
  </Card>
</CardGrid>
...
<CardGrid cols={2}>
  <Card title="📚 Execution Guides">
    Step-by-step guides for campaign planning and execution
    
    **Browse:** [Campaign Guides](/guides/)
    
    <Badge text="Guides" variant="tip" />
  </Card>
  
  <Card title="📋 Reference Materials">
    Technical specs, templates, and business context materials
    
    **Browse:** [Reference Library](/reference/)
    
    <Badge text="Reference" variant="note" />
  </Card>
</CardGrid>
...
<CardGrid cols={3}>
  <Card title="Stage 1: Early Adopters">
...
<Aside type="caution" title="Content Strategy">
  All resources are optimized for the three-stage campaign approach. Customize messaging for your specific audience and product.
</Aside>
  ...
  <TabItem label="🎬 Video Scripts">
    <CardGrid cols={1}>
      ...
      <LinkCard
        ...
        description="Targeted video content resources for each campaign stage and audience"
...
<CardGrid cols={2}>
  ...
  <LinkCard
    title="Infographic Resources"
        description="Data visualization designs and infographic resources for campaign storytelling"
...
<CardGrid cols={2}>
  ...
  <LinkCard
    title="Master Resource Collection"
    description="Complete toolkit with all resources and tools for comprehensive campaign management"
...
<CardGrid cols={3}>
  ...
  <Card title="Campaign Analytics">
    ...
    **Focus:** Performance insights and reporting
    ...
    [View Resource →](/strategic-analysis/campaign-analytics-template)
  </Card>
  ...
  <Card title="A/B Testing Framework">
  ...
  <Card title="Budget Template">
    ...
    **Focus:** Financial control and budgeting
    ...
    [View Resource →](/project-management/budget-template)
  </Card>
</CardGrid>
...
- **✍️ Content Writer**: [All Copy Resources](campaign-core/) | [Email Sequences](email-marketing/) | [Ad Copy](advertising/)
...
**🆘 Getting Help**
- **Resource Questions**: Check related documents in same folder
...
- **Resource Updates**: Monitor for new versions and improvements
- **Performance Feedback**: Use analytics to inform resource refinements
