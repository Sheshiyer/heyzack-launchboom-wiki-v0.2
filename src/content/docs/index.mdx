...
<CardGrid cols={2}>
  ...
  <Card title="✍️ Content Creator" icon="pencil">
    ...
    **Start Here:** [Content Resources](/campaign-core/)
    
    <Badge text="Resources" variant="note" />
  </Card>
  ...
  <Card title="🚀 All-in-One" icon="open-book">
    ...
    **Start Here:** [All Resources](/resources-master/resource-collection/)
...
<CardGrid cols={2}>
  ...
  <LinkCard
    ...
    href="/resources-master/resource-collection"
  />
</CardGrid>
