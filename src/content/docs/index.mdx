...
<CardGrid cols={2}>
  <Card title="🏗️ Foundation" icon="star">
  ...
  <Card title="🎯 Campaign Core" icon="rocket">
  ...
  <Card title="📊 Advertising" icon="megaphone">
  ...
  <Card title="🛠️ Supporting Materials" icon="tools">
...
<CardGrid cols={2}>
  <Card title="📚 Execution Guides" icon="book">
  ...
  <Card title="📋 Reference Materials" icon="clipboard">
